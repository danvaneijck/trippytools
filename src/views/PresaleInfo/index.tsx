...
const PreSaleInfo = () => {
    ...
    return <div ref={myRef} className='overflow-hidden'>
        <div>
            ...
            <div className='mt-2 text-center py-2 text-2xl md:text-4xl md:w-1/3 m-auto rounded-xl p-2 mb-2 bg-gradient-to-br from-transparent to-black '>
            ...
            <div className='mt-2 text-center py-5 text-2xl md:text-5xl md:w-1/2  m-auto rounded-xl p-2 mb-2 bg-gradient-to-br from-transparent to-black'>
                ...
                <div className='text-xl md: text-3xl'>
                    send up to <span className='font-bold text-2xl md:text-4xl'>10,000,000 $SHROOM</span> tokens <br /> with your $INJ to get a <span className='font-bold text-3xl md:text-5xl'>1.25x</span> multiplier on your allocation
                </div>
