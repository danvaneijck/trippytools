...
const ReflectionTokenLaunch = () => {
    ...
    const [newTreasuryAddress, setNewTreasuryAddress] = useState<string | null>(null);
    ...
    const handleLaunchSuccess = (addresses: { tokenAddress: string; treasuryAddress: string }) => {
        setNewTokenAddress(addresses.tokenAddress);
        setNewTreasuryAddress(addresses.treasuryAddress);
                        ...
                        <div className="w-full max-w-screen-md px-2 pb-10">
                            {newTokenAddress && newTreasuryAddress ? (
                                <TokenSetupWizard
                                    ...
                                    tokenDecimals={tokenDecimals}
                                    initialTaxRates={{ globalRate, reflectionRate, burnRate, antiwhaleRate }}
                                />
                            ) : (
